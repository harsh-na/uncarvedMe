...
import { SiCodechef , SiJavascript, SiMysql, SiPhp, SiCodeforces, SiLeetcode, SiExpress, SiBootstrap, SiMui, SiSocketdotio, SiOpencv, SiGooglecolab, SiPython, SiJupyter, SiAnsys, SiMicrosoftexcel, SiGithub, SiFigma, SiEthereum, SiSolidity, SiMetamask, SiNotion, SiVisualstudiocode, SiPostman, SiNodemon} from 'react-icons/si'
...
const data = [
  {
    ...
    icons: [
      ...
      {
        name: "Codechef",
        link: "https://www.codechef.com/users/harsh_na",
        logo: <SiCodechef />,
      },
      {
        name: "Codeforces",
        link: "https://codeforces.com/profile/harsh-na",
        logo: <SiCodeforces />,
      },
      {
        name: "Leetcode",
        link: "https://leetcode.com/harsh_na710/",
        logo: <SiLeetcode />,
      },
    ],
  },
